...
export default async function Page({ params }: pageProps) {
    ...
    if (playlistData.tracks.items.length === 0) {
        return (
            <div className="flex flex-col min-w-full items-center justify-center  text-center  p-6 gap-x-10">
    ...
    return (
        <div className="flex flex-col min-w-full items-center justify-center p-6 gap-x-10 md:flex-row ">
            <div className="h-full w-full md:w-[35%] flex justify-center items-center overflow-hidden relative  md:basis-4/12">
                <header className="flex flex-col items-center py-6 gap-y-2 md:fixed md:top-[20%]">
                    <Image
                    ...
                    >
                        <h1 className="mt-2 font-semibold text-3xl opacity-90 hover:text-green-500">
            ...
            <div className="basis-2/3 md:w-[70%]">
